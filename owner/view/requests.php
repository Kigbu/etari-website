                                                    ...
                                                    <?php 
                                                        ...
                                                        if($paginate->total_pages() >= 1){
                                                            if($paginate->has_previous_page()){
                                                                ...
                                                                echo '<a class="page-link" href="index.php?goto=requests&page=';echo $paginate->previous_page() ; echo'" aria-label="Previous">';   echo '<span aria-hidden="true">&laquo;</span>';  
                                                            ...
                                                            for($i = 1; $i <= $paginate->total_pages(); $i++){
                                                                if($i == $page_state){
                                                                    ...
                                                                    echo '<a class="page-link active href="index.php?goto=requests&page='; echo $i; echo '">'; echo $i; echo '</a>';
                                                                    echo "</li>";
                                                                }else{
                                                                    echo '<li class="page-item">';
                                                                    echo '<a class="page-link" href="index.php?goto=requests&page='; echo $i; echo '">'; echo $i; echo '</a>';	
                                                                    echo '</li>';
                                                                }
                                                            }
                                                            if($paginate->has_next_page()){
                                                                echo '<li class="page-item"><a class="page-link" href="index.php?goto=requests&page=';
											...
											<tbody>
                                                <?php 
                                                    ...
                                                    foreach($requestlist as $requests){
														$view = urlencode('index.php?goto=viewrequest&r_id='.escape($requests->request_id));
                                                ?>
												<!--href="index.php?goto=viewrequest&requestid="-->
												<tr class="requestrow" data-requesttarget="<?php echo $view; ?>" >
													<td>
													...
													<td><span class="from" title="<?php echo escape($requests->email);?>"><?php echo escape($requests->name);?> </span></td>
													<td><span class="message-label label2">New</span>
														<span class="title"><?php echo escape($requests->request_service.'('.$requests->request_package.')');?></span> <span class="preview">- <?php echo escape($requests->message);?> </span></td>
													<!--<td><span class="icon-attachment"><i class="fa fa-paperclip"></i></span></td>-->
													<td><span class="timestamp"><?php echo datetime_to_text(escape($requests->request_date));?></span></td>
												</tr>
                                                <?php } }?>
											</tbody>
										</table>
