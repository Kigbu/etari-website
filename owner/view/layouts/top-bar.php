            ...
            <div class="container">
                <div class="clearfix">
                    ...
                    <!-- <div class="pull-left left logo">
                        <a href="index.php?goto=dashboard"><img src="includes/assets/img/kingadmin-logo-white.png" alt="Etari - Admin Dashboard" /></a>
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <a href="#">
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <img class="media-object" src="includes/assets/img/user1.png" alt="Antonio">
                                                            </div>
                                                ...
                                                <li class="inbox-item unread clearfix">
                                                    <a href="#">
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <img class="media-object" src="includes/assets/img/user2.png" alt="Antonio">
                                                            </div>
                                                            <div class="media-body">
                                                ...
                                                <li class="inbox-item unread clearfix">
                                                    <a href="#">
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <img class="media-object" src="includes/assets/img/user3.png" alt="Antonio">
                                                            </div>
                                                            <div class="media-body">
                                                ...
                                                <li class="inbox-item clearfix">
                                                    <a href="#">
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <img class="media-object" src="includes/assets/img/user4.png" alt="Antonio">
                                                            </div>
                                                            <div class="media-body">
                            ...
                            <div class="logged-user">
                                <div class="btn-group">
                                    <a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                        <img height="24px" width="24px"  src="includes/assets/img/user.png" alt="User Avatar" />
                                        <span class="name"><?php echo $user->data()->username;?></span> <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="index.php?goto=dashboard">
